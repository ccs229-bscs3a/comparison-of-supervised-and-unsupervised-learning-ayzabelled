...
def app():
    ...
    st.subheader('Supervised Learning, Classification, and KNN with Oxford Flowers Dataset')
    ...
    The Oxford Flowers dataset contains images of various flower species. 
    We'll use K-means clustering to explore how the images group together based on their visual characteristics
    \n**KNN Classification with Oxford Flowers:**
    \n1. **Training:**
    * The KNN algorithm stores the entire Oxford Flowers dataset (features and labels) as its training data.
    \n2. **Prediction:**
    * When presented with a new Oxford Flowers (unknown species), KNN calculates the distance (often Euclidean distance) 
